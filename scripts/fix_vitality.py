...
# Historical one-off: this produced the *_v2.json files that are now the
# canonical timeline_by_year/{year}.json snapshots. Kept for provenance; run
# from the repo root. Paths point at the client data dir.
_REPO_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DATA_DIR = os.path.join(_REPO_ROOT, "client", "src", "data")
